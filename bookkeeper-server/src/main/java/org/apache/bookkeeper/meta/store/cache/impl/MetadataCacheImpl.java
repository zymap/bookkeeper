 ...
 * under the License.
 */
package org.apache.bookkeeper.meta.store.cache.impl;
...
import org.apache.bookkeeper.meta.store.api.MetadataCache;
import org.apache.bookkeeper.meta.store.api.MetadataStore;
import org.apache.bookkeeper.meta.store.api.Notification;
import org.apache.bookkeeper.meta.store.api.Stat;
import org.apache.bookkeeper.meta.store.api.MetadataStoreException.AlreadyExistsException;
import org.apache.bookkeeper.meta.store.api.MetadataStoreException.BadVersionException;
import org.apache.bookkeeper.meta.store.api.MetadataStoreException.ContentDeserializationException;
import org.apache.bookkeeper.meta.store.api.MetadataStoreException.NotFoundException;
...
public class MetadataCacheImpl<T> implements MetadataCache<T>, Consumer<Notification> {
    ...
    public Optional<T> getIfCached(String path) {
        CompletableFuture<Optional<Entry<T, Stat>>> future = objCache.getIfPresent(path);
    ...
    public CompletableFuture<Void> readModifyUpdate(String path, Function<T, T> modifyFunction) {
        return executeWithRetry(() -> objCache.get(path)
                .thenCompose(optEntry -> {
                    ...
                    Entry<T, Stat> entry = optEntry.get();
